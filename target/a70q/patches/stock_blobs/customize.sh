...
echo "Reverting to SoundBooster v1050"
...
REMOVE_FROM_WORK_DIR "$WORK_DIR/system/system/lib64/libsamsungSoundbooster_plus_legacy.so"
REMOVE_FROM_WORK_DIR "$WORK_DIR/system/system/lib/libsamsungSoundbooster_plus_legacy.so"
...
ADD_TO_WORK_DIR "system" "system/lib/lib_SoundBooster_ver1050.so" 0 0 644 "u:object_r:system_lib_file:s0"
ADD_TO_WORK_DIR "system" "system/lib/libsamsungSoundbooster_plus_legacy.so" 0 0 644 "u:object_r:system_lib_file:s0"
