...
REMOVE_FROM_WORK_DIR "$WORK_DIR/system/system/etc/permissions/com.sec.feature.cover.sview.xml"
...
ADD_TO_WORK_DIR_CONTEXT "system" "system/etc/permissions/com.sec.feature.nsflp_level_530.xml" 0 0 644 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR_CONTEXT "system" "system/etc/permissions/com.sec.feature.sensorhub_level30.xml" 0 0 644 "u:object_r:system_file:s0"
