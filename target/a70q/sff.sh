...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_WIDE_DISTORTION_CORRECTION=
...
SEC_FLOATING_FEATURE_LCD_CONFIG_NIGHT_DIM=
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=ai_clear_zoom.arcsoft.v2,food.samsung.v1,super_night.mpi.v2,scene_detection.samsung.v1,image_enhance.arcsoft.v1,beauty.samsung.v4,face_landmark.arcsoft.v2_1,facial_attribute.samsung.v1,swuwdc.arcsoft.v1,human_tracking_hand.arcsoft.v4,fr_tracking.arcsoft.v1,dual_bokeh.samsung.v1_1,macro_raw_sr.arcsoft.v1,single_bokeh.samsung.v2,mfhdr.arcsoft.v4,hybridhdr.arcsoft.v1,aebhdr.arcsoft.v1,llhdr.arcsoft.v4,aimode.samsung.v2_1,aimfisp.samsung.v1,pro_single_rgb.mpi.v1,facial_restoration.arcsoft.v1,smart_scan.samsung.v2,selfie_correction.samsung.v2,event_detection.samsung.v2,localtm.samsung.v1_1,super_resolution_tetra.samsung.v1,image_codec.samsung.v1
