...
SEC_FLOATING_FEATURE_CAMERA_GRAW_CONFIG_MFP_PIPELINE_MODE=
...
SEC_FLOATING_FEATURE_SENSOR_CONFIG_SABC_CAMERA_TYPE=
...
# Device specific
#SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A70
#SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=3
#SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA705FN
