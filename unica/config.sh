...
case "$TARGET_SINGLE_SYSTEM_IMAGE" in
    ...
    "qssi")
        ...
        SOURCE_FIRMWARE="SM-S911B/EUX/351708816740511"
    ...
    "qssi_64")
        # Galaxy S24 Ultra (One UI 6.1.1)
        SOURCE_FIRMWARE="SM-S928B/EUX/355731678546152"
        SOURCE_EXTRA_FIRMWARES=("SM-S918B/EUX/351868490760126")
        SOURCE_API_LEVEL=34
        ...
        SOURCE_MDNIE_WEAKNESS_SOLUTION_FUNCTION="3"
        SOURCE_MULTI_MIC_MANAGER_VERSION="08020"
        SOURCE_SSRM_CONFIG_NAME="siop_e3q_sm8650"
        SOURCE_SUPPORT_CUTOUT_PROTECTION=false
        ;;
    *)
